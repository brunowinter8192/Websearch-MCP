## Live focus-steal probe (20260826T213655Z)
- Lane: camoufox
...
- Wall time (browser launch to subprocess exit): 7.8s

## Verdict
- Instrument 1 (frontmost app): 8 samples, 0 deviations, longest continuous deviation 0.0s
- Instrument 2 (AXMain key-window): 8 samples, 6 deviations, longest continuous deviation 5.26s

## Observed sampling resolution (real, not nominal — see sample_gaps/instrument_resolution_stats)
- Instrument 1: mean interval 0.809s, max gap 3.39s, effective rate ~1.24 samples/s
...
t=5.07s, t=5.45s, t=5.82s, t=6.19s, t=6.56s, t=6.94s
